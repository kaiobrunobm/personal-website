...
const About: React.FC = () => {
  return (
    <div className='flex flex-col items-center self-stretch gap-6 pt-32'>
      <div className='flex flex-col items-center justify-center gap-6 self-stretch px-6 pb-[19rem] md:text-xl'>
        <p className='text-center'>I'm a <span className='font-bold text-highlights'>full-stack</span> developer and <span className='font-bold text-highlights'>UX/UI designer
